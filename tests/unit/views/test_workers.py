...
class WorkersTests(AsyncHTTPTestCase):
    ...
    def test_task_received(self):
        ...
        self.assertEqual(['worker1', 'True', '0', '1', '0', '0', '0', '0', None],
                         table.get_row('worker1'))
    ...
    def test_task_succeeded(self):
        ...
        self.assertEqual(['worker1', 'True', '0', '1', '0', '0', '1', '0', None],
                         table.get_row('worker1'))
        self.assertEqual(['worker2', 'True', '0', '0', '0', '0', '0', '0', None],
                         table.get_row('worker2'))
    ...
    def test_task_failed(self):
        ...
        self.assertEqual(['worker1', 'True', '0', '1', '0', '1', '0', '0', None],
                         table.get_row('worker1'))
        self.assertEqual(['worker2', 'True', '0', '0', '0', '0', '0', '0', None],
                         table.get_row('worker2'))
    ...
    def test_task_retried(self):
        ...
        self.assertEqual(['worker1', 'True', '0', '1', '0', '1', '0', '1', None],
                         table.get_row('worker1'))
        self.assertEqual(['worker2', 'True', '0', '0', '0', '0', '0', '0', None],
                         table.get_row('worker2'))
    ...
    def test_tasks(self):
        ...
        self.assertEqual(['worker1', 'True', '0', '100', '0', '0', '100', '0', None],
                         table.get_row('worker1'))
        self.assertEqual(['worker2', 'True', '0', '0', '0', '0', '0', '0', None],
                         table.get_row('worker2'))
        self.assertEqual(['worker3', 'True', '0', '23', '0', '13', '10', '0', None],
